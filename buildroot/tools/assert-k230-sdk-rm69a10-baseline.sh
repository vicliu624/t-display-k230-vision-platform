...
CPU1_MAILBOX_PATCH="${PROJECT_DIR}/buildroot/k230-sdk-overlay/linux/0063-tdvp-cpu1-rtsmart-mailbox.patch"
...
require_content "${STAGED_OVERLAY}/package/tdvp-vglite-acceptance/tdvp-vglite-acceptance.mk" 'tdvp-vglite-diagnostics-report'
	...
	require_file "${STAGED_OVERLAY}/linux/0063-tdvp-cpu1-rtsmart-mailbox.patch"
	require_content "${STAGED_OVERLAY}/linux/0063-tdvp-cpu1-rtsmart-mailbox.patch" 'tdvp,k230-cpu1-mailbox'
