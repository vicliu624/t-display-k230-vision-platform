...
grep -Fqx 'renderer_stack_kernel_vglite_inflight_close_patch_sha256=43bd02e796a6af85c8ea3f02b2e2813409d3427da858fffcb617ae87b121f6a3' "${BASELINE}"
...
grep -Fqx 'renderer_stack_kernel_vglite_wait_watchdog_patch_sha256=689eaf207bd1fc6cd48d9dabbe946ace75b5001e35e87d399380402ce21a5d58' "${BASELINE}"
