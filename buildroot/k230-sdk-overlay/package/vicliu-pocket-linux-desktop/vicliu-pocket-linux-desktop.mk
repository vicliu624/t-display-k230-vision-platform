...
VICLIU_POCKET_LINUX_DESKTOP_DEPENDENCIES = alsa-utils foot iw mc mpv sudo v4l2grab wayland wofi wvkbd wlr-randr yavta
...
define VICLIU_POCKET_LINUX_DESKTOP_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -D -m 0644 $(@D)/wofi/style.css \
		$(TARGET_DIR)/etc/xdg/wofi/style.css
	$(INSTALL) -D -m 0755 $(@D)/bin/vpl-app-launcher \
		$(TARGET_DIR)/usr/local/bin/vpl-app-launcher
	$(INSTALL) -D -m 0755 $(@D)/bin/vpl-audio-menu \
	...
	$(INSTALL) -D -m 0755 $(@D)/bin/vpl-files \
	...
	$(INSTALL) -D -m 0755 $(@D)/bin/vpl-wifi \
		$(TARGET_DIR)/usr/local/bin/vpl-wifi
	$(INSTALL) -D -m 0644 $(@D)/applications/vpl-audio.desktop \
	...
	$(INSTALL) -D -m 0644 $(@D)/applications/vpl-files.desktop \
	...
	$(INSTALL) -D -m 0644 $(@D)/applications/vpl-wifi.desktop \
