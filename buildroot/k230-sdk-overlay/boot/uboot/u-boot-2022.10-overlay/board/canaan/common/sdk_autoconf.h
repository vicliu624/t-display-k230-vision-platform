/* TDVP override of the pinned SDK header: keep SPL, U-Boot and Linux on CPU0.
 * CONFIG_LINUX_RUN_CORE_ID=1 transfers U-Boot to CPU1, where boot_baremetal 1
 * would reset the executing bootloader before it could enter Linux.
 */
#define CONFIG_LINUX_DTB "k230_canmv"
#define CONFIG_BOARD_K230_CANMV 1
#define CONFIG_GEN_IMG_SCRIPT "board/k230_evb_only_linux/gen_image.sh"
