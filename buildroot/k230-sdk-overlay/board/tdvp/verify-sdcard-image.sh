...
require_fs_path "${ROOTFS}" '/usr/lib/systemd/system/bluetooth.service'
require_fs_path "${ROOTFS}" '/usr/libexec/bluetooth/bluetoothd'
require_fs_path "${ROOTFS}" '/usr/bin/bluetoothctl'
...
require_fs_path "${ROOTFS}" '/usr/bin/aplay'
require_fs_path "${ROOTFS}" '/usr/bin/paplay'
require_fs_path "${ROOTFS}" '/usr/bin/ffmpeg'
require_fs_path "${ROOTFS}" '/usr/bin/ffprobe'
...
require_fs_path "${ROOTFS}" '/etc/pam.d/swaylock'
require_fs_path "${ROOTFS}" '/usr/local/bin/tdvp-greeter-session'
require_fs_path "${ROOTFS}" '/usr/local/bin/tdvp-session-lock'
...
require_fs_path "${ROOTFS}" '/usr/lib/libutf8proc.so.3'
...
require_rootfs_line '/usr/local/bin/tdvp-greeter-session' '^export WLR_RENDERER=pixman$'
...
require_rootfs_line '/etc/group' '^render:.*:.*tdvp'
